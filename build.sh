...
${nuget_cmd} install src/Salesforce.MarketingCloud/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Salesforce.MarketingCloud.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Salesforce.MarketingCloud.dll \
-recurse:'src/Salesforce.MarketingCloud/*.cs' \
-doc:bin/Salesforce.MarketingCloud.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Salesforce.MarketingCloud.dll was created successfully"
fi
